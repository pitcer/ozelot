...
/// It will never panic if called with a key generated by generate_rsa_key
pub fn rsa_key_binary(key: &Rsa<Private>) -> Vec<u8> {
...
pub fn rsa_decrypt(key: &Rsa<Private>, data: &[u8]) -> Result<Vec<u8>> {
    if data.len() != 128 {
